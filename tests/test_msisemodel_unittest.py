...
class TestMSISE_Model(unittest.TestCase):
    ...
    def test_msiseModel(self):
        ...
        msiseModel = MSISE_Model(ionosphereState = ionosphereState, currentDateTime=currentDateTime)
        ...
        msiseOutput = msiseModel.generateSetEstimateFromRayState(rayPoints=slantPath)
        
        self.assertTrue(len(msiseOutput) > 0)
